...
|----------|-----|--------|-------|
| — | TypeScript | ✅ shipped | [`@ifx-run/sdk`](https://www.npmjs.com/package/@ifx-run/sdk) **`0.1.3`** |
| **P0 — high** | **Go SDK** | ✅ shipped | [`go-sdk/`](../go-sdk/README.md) **`v0.1.3`** — planner + L0–L3 e2e; [examples](../go-sdk/examples/README.md) |
| **P1 — medium** | **Rust SDK** | ✅ shipped | [`ifx-sdk`](https://crates.io/crates/ifx-sdk) **`0.1.3`** + `ifx-core`; [rust-integration.md](./rust-integration.md) |
...
|----------|---------|---------|
| TypeScript | `@ifx-run/sdk@0.1.3` | `npm install @ifx-run/sdk` |
| Go | `github.com/ifx-run/ifx/go-sdk@v0.1.3` | `go get github.com/ifx-run/ifx/go-sdk@v0.1.3` |
| Rust | `ifx-sdk@0.1.3` | `cargo add ifx-sdk@0.1.3` |

Pin the same **0.1.3** revision across languages for production. Wire golden tests live under repo `tests/` and `go-sdk/integration/`, `rust-sdk/tests/`.
...
5. **IDL** — ship bundled `idl/ifx.json`; pin **SDK `0.1.3`** and program id for your cluster.
