...
| 优先级 | SDK | 状态 | 说明 |
|--------|-----|------|------|
| — | TypeScript | ✅ 已交付 | [`@ifx-run/sdk`](https://www.npmjs.com/package/@ifx-run/sdk) **`0.1.1`** |
| **P0 — 高** | **Go SDK** | ✅ 已交付 | [`go-sdk/`](../go-sdk/README.zh-CN.md) **`v0.1.1`** — planner + L0–L3 e2e；[examples](../go-sdk/examples/README.zh-CN.md) |
| **P1 — 中** | **Rust SDK** | ✅ 已交付 | [`ifx-sdk`](https://crates.io/crates/ifx-sdk) **`0.1.1`** + `ifx-core`；[rust-integration.zh-CN.md](./rust-integration.zh-CN.md) |
...
生产环境请在各语言侧 **同时 pin 0.1.1**。Wire golden tests 见仓库 `tests/`、`go-sdk/integration/`、`rust-sdk/tests/`。
...
5. **IDL** — 各 SDK 附带 bundled `idl/ifx.json`；生产请 pin **SDK `0.1.1`** 与目标集群 program id。
