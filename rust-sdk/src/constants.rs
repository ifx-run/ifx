...
pub use ifx_core::{
    index_cap_for_tape_len, ACCOUNT_DISC_FRAME, FRAME_SEED, IX_DISC_ASSERT,
    IX_DISC_ASSERT_MULTI, IX_DISC_CLOSE_FRAME, IX_DISC_CREATE_FRAME, IX_DISC_IF_ELSE,
    IX_DISC_LET, IX_DISC_PATCHED_CPI, IX_DISC_RESET_FRAME, MAX_BINDING_INDEX,
    MAX_FRAME_TAPE_LEN, MIN_TAPE_LEN,
};
