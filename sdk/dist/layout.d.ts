...
export type SnapshotReadResult<T extends IfxTy> = T extends "bool" ? boolean : T extends "u8" | "u16" | "u32" | "i8" | "i16" | "i32" | "f32" | "f64" ? number : T extends "u64" | "u128" | "i64" ? bigint : T extends "i128" ? BN : never;
...
export declare class DecodedFrame {
    ...
    constructor(closeAuthority: PublicKey, cursor: number, indexCount: number, indexCap: number, payloadAt: readonly number[], tape: Buffer);
