 ...
 */
export declare const EXPR_VARIANT: readonly ["value", "constBool", "constU8", "constU16", "constU32", "constU64", "constU128", "constI8", "constI16", "constI32", "constI64", "constI128", "constF32", "constF64", "not", "neg", "isZero", "nonZero", "asU8", "asU16", "asU32", "asU64", "asU128", "asI8", "asI16", "asI32", "asI64", "asI128", "add", "sub", "mul", "div", "divFloor", "divCeil", "min", "max", "eq", "ne", "gt", "ge", "lt", "le", "saturatingSub", "and", "or", "bpsMulFloor", "bpsMulCeil", "mulDivFloor", "mulDivCeil", "clamp", "select", "constPubkey"];
export type ExprVariantKey = (typeof EXPR_VARIANT)[number];
export declare const EXPR_VARIANT_COUNT: 52;
/** Next append-only Expr tag (see `docs/implementation.md` §5). */
export declare const EXPR_NEXT_TAG: 52;
